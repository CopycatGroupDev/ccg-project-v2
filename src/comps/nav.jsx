...
export const Nav = ({ setNavOpened, navOpened, textColor }) => {
  ...
  return (<div className='flex flex-col h-1/3 justify-start items-center' id="nav">
          <div className='flex justify-between lg:justify-right lg:justify-center relative max-w-[1500px] w-full max-lg:items-center max-lg:gap-2 items-start lg:max-xl:flex-col lg:max-xl:items-center'>
              ...
              <button className='max-lg:block hidden mx-8 z-[9998]' onClick={() => setNavOpened(!navOpened)}>
...
export const NavMobile = ({ setNavOpened, navOpened }) => {
  ...
  return <motion.div className='fixed bg-[#fffd] backdrop-blur z-[9999] w-full h-full [body:has(&)]:overflow-hidden p-5 flex flex-col items-center overflow-auto' initial={{opacity: 0}} transition={{duration: 0.5}} whileInView={{opacity: 1}}>
